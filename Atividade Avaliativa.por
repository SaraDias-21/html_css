programa {
  ...
  leia(grossSalary)
  escreva("Digite o número de dependente(filhos): ")
  leia(children)
...
escreva("Não haverá pagamento de vale transporte e nem desconto\n")
voucher=0
  }
//Desconto INSS//
...
deduction = 0
  ...
  se(action==1){
    escreva("Obrigada pela preferenvia, retorne sempre!")
      }
    }
  }
}
